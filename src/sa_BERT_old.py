...
databaseName2Info ={'imdb':{'dir':"IMDB Reviews",'fnc':data4SAandBERT_old.readImdbData},
                   'rt':{'dir':"RT_Sentiment",'fnc':data4SAandBERT_old.readImdbData}
                   }
...
def getIMDBData(DATA_INFO, DATA_LOCATION_RELATIVE_TO_CODE, DATA_VERSION_APPENDIX):
    ...
    imdbTrainData = data4SAandBERT_old.readImdbData(train_dir_Imdb, readFromSource=DATA_INFO.READ_FROM_SOURCE)
    ...
    imdbTestData = data4SAandBERT_old.readImdbData(test_dir_Imdb, readFromSource=DATA_INFO.READ_FROM_SOURCE)
